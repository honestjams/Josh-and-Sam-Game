...
export const SKILLS: Record<Id, SkillDefinition> = {
  ...
  'skill.guard-bash': {
    id: 'skill.guard-bash',
    name: 'Guard Bash',
    description: 'A shield slam that dazes a single foe.',
    mpCost: 3,
    element: 'neutral',
    target: 'single-enemy',
    effect: 'damage',
  ...
  'skill.spore-heal': {
    id: 'skill.spore-heal',
    name: 'Spore Heal',
    description: 'A cloud of restorative spores mends the whole party.',
    mpCost: 6,
    element: 'growth',
    target: 'all-allies',
    effect: 'heal',
  ...
  'skill.gale': {
    id: 'skill.gale',
    name: 'Gale',
    description: 'A cutting gust that strikes every enemy.',
    mpCost: 5,
    element: 'growth',
    target: 'all-enemies',
    effect: 'damage',
